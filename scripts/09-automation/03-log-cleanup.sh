...
# 错误处理
trap 'log_error "日志清理脚本异常退出 (行号: $LINENO)"' ERR
...
# ========================= Journald 清理 =========================
# ========================= Journald 清理 =========================
# 功能: 清理超过保留天数的journald日志
# 保留策略: $JOURNAL_RETENTION_DAYS 天 (默认7天)
clean_journald() {
    report ""
...
# ========================= 系统日志清理 =========================
# ========================= 系统日志清理 =========================
# 功能: 清理/var/log和/var/log/audit下的旧日志
# 操作: 删除旧日志、压缩3天以上日志、强制logrotate
clean_syslog() {
    report ""
    report "==================== 系统日志清理 ===================="
...
# ========================= Docker 日志清理 =========================
# ========================= Docker 日志清理 =========================
# 功能: 清理已停止容器、悬空镜像、未使用的网络/卷
# 命令: docker container prune, docker system prune
clean_docker() {
    report ""
    report "==================== Docker 日志清理 ===================="
...
# ========================= K8s Pod 日志清理 =========================
# ========================= K8s Pod 日志清理 =========================
# 功能: 清理已完成/失败/Evicted的Pod和已完成的Job
# 命名空间: 所有命名空间
clean_kubernetes() {
    report ""
